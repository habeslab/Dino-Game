...
int joy_SW_pin = GPIO_PIN_2; // Pin digitale connesso al pulsante del joystick
int joy_X_pin = GPIO_PIN_0;  // Pin analogico connesso all'output X del joystick
int joy_Y_pin = GPIO_PIN_1;  // Pin analogico connesso all'output Y del joystick
...
void clear_custom_char() {
    // ensures all custom character slots are clear before new custom characters can be defined.
    uint8_t blank[8] = {
